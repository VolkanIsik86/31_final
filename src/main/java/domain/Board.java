    ...
    public void makeBoard(TxtReader squareTxt, TxtReader landedOnTxt, TxtReader cardsTxt, GUILogic guiLogic){
        ...
        for (int i = 0; i < SIZE; i++) {
            ...
            if ("Regular".equalsIgnoreCase(oneLine[0])) {
                ...
                squares[i] = ownables[rekt] = new PropertySquare(oneLine[1], Integer.parseInt(oneLine[2]), landedOnTxt, Integer.parseInt(oneLine[3]), oneLine[0],oneLine[4],Integer.parseInt(oneLine[5]),rentsInts, this);
                rekt++;
